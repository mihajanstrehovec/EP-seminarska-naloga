CREATE DATABASE  IF NOT EXISTS `precum` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `precum`;

-- MySQL dump 10.13  Distrib 8.0.22, for Linux (x86_64)
--
-- Host: localhost    Database: precum
-- ------------------------------------------------------
...
INSERT INTO `Stranka` VALUES (1,'Foo','Bar','foobar@gmail.com','$2y$10$kQnrvbTaGwy4KKiXsTZuv.VviFXN8QLh5TDZyDEI65EZHl1iIGzI6',1,'Gosposvetska',12,'Ljubljana',1000);
/*!40000 ALTER TABLE `Stranka` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'h'
--

--
-- Dumping routines for database 'h'
--
...
-- Dump completed on 2020-12-20 17:44:56
